...
<div className="mx-auto max-w-5xl mb-4 md:mb-6 flex items-center justify-between">
  {/* Titolo + pulcino; su mobile le icone stanno in colonna accanto al pulcino */}
  <div className="flex items-center gap-4">
    ...
    <div className="flex items-center">
      ...
      {/* MOBILE: icone una sopra l’altra, accanto al pulcino */}
      <div className="ml-1 flex flex-col gap-1 sm:hidden">
        <button
